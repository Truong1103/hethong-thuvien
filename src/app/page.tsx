...
export default async function Home() {
  ...
  return (
    <div className="space-y-16 pb-12">
      ...
      <section className="rounded-3xl border border-zinc-200/90 bg-white p-6 shadow-sm sm:p-10">
        ...
        <ul className="mx-auto mt-10 grid max-w-4xl gap-4 sm:grid-cols-2">
          {[
            ...
            <li
              key={t}
              className="flex gap-4 rounded-2xl border border-zinc-100 bg-zinc-50/60 p-4 text-left transition hover:border-teal-100 hover:bg-white"
            >
      ...
      <section className="overflow-hidden rounded-3xl bg-gradient-to-r from-teal-700 via-teal-600 to-emerald-600 px-6 py-10 text-center shadow-xl shadow-teal-900/25 sm:px-10">
      ...
      <section className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-3">
          {faq.map((item) => (
            <details
              key={item.q}
              className="group rounded-2xl border border-zinc-200/90 bg-white px-4 py-3 shadow-sm open:shadow-md"
            >
      ...
      <section className="rounded-3xl border border-dashed border-zinc-300 bg-zinc-50/80 px-6 py-10 text-center">
